	...
	function peerius_attribute_csv(){
		...
		*/
		...
		$peeriusAttributes = $this->PeeriusAttribute->find('all',
			array(
				'order' => array('PeeriusAttribute.quick_code' => 'ASC'),
		...
		if(!empty($peeriusAttributes)){
				...
				foreach($peeriusAttributes as $peeriusAttribute){
					...
					$Content1 .=  ((!empty($productMusicRated[$peeriusAttribute["PeeriusAttribute"]["id"]])) ? $productBookFormat[$peeriusAttribute["PeeriusAttribute"]["id"]] : "0")."\t\t";
					$Content1 .=  ((!empty($productMusicNodisk[$peeriusAttribute["PeeriusAttribute"]["id"]])) ? $productBookFormat[$peeriusAttribute["PeeriusAttribute"]["id"]] : "0")."\t\t";
					
					$Content1 .=  $peeriusAttribute['PeeriusAttribute']['track_list']."\t\t";
