    ...
    private function __resizePng($original, $new_filename, $scaled_width, $scaled_height, $width, $height, $quality) {
     ...
     function resizeThumbnailImage($thumb_image_name, $image, $width, $height, $start_width, $start_height, $scale){
        ...
        if($ext == "gif")        
        {
          ...
          $trnprt_indx = @imagecolortransparent($newImage);
          $trnprt_color = @imagecolorsforindex($newImage, $trnprt_indx);
        ...
        else
        {
          ...
          switch ($ext) {
            case "gif": $im = imagecreatefromgif($image); break;
            case "jpg": $im = imagecreatefromjpeg($image); break;
            case "png": $im = imagecreatefrompng($image); break;
           }        
          $newImage = imagecreatetruecolor($newImageWidth,$newImageHeight);
          ...
          imagecopyresampled($newImage, $im, 0, 0, 0, 0, $newImageWidth, $newImageHeight, $newImageHeight, $newImageHeight);
        } 
