 ...
 * @access public 
 */ 
    var $resultsPerPage = array(2,4,5,10,20,50,100,500); 
/** 
 ...
 */ 
    ...
    { 
		...
		elseif(@array_key_exists($parameter,$parameters)) //modified : 24/10/2007
		{
			...
			$this->paging[$field] = $this->Sanitize->paranoid($parameters[$parameter],array("-","_")); 
                ...
                { 
                    $this->paging[$field]= $this->$field;  //here it works
                } 
            } 
