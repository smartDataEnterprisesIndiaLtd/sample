<?php
	...
	$this->Html->addCrumb('Faqs', 'javascript:void(0)');
...
?>
	...
	<tr>
		...
		<?php echo $html->link('<span>Add New</span>',array("controller"=>"faqs","action"=>"add") , array('escape'=>false,'class'=>'wt_btn','title'=>'Add New') ); ?>
		</td>
	</tr>
		...
		<td colspan="2">
 			<table width="100%" cellspacing="0" cellpadding="0" align="center" border="0">
				<tr class="adminBoxHeading">
					<td height="25" class="reportListingHeading">Search Faqs</td>
				</tr>
				<tr>
					<td>
						<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
							<tr>
								<td>
									<?php echo $form->create("Faq",array("action"=>"index","method"=>"Post", "id"=>"frmSearchFaq", "name"=>"frmSearchFaq"));?>
