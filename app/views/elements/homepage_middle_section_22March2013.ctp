...
<div class="row">
	...
	<div class="products-widget outerdiv_resolution div_resolution_middle_height">
		<ul class="products">
			...
			?>
			<li class="inner_div_resolution"><div style ="padding:0 5px">
				...
				<p class="star-rating">
					...
					<span class="price">
						...
						<s><?php echo CURRENCY_SYMBOL.$format->money($pos1_newreleases[$i]['Product']['product_rrp'],2);?> </s>
						<?php }else{
							echo CURRENCY_SYMBOL.$format->money($pos1_newreleases[$i]['Product']['product_rrp'],2);
						} ?>
					...
					<div class="left-product-content">
						<ul class="pick-of-week-content">
							<li>
								...
								<div class="button-widget" style="float: right; padding-right: 142px;">
									<?php
										if($prodStock > 0){
											echo $form->button('BUY',array('type'=>'button','class'=>'orange-btn','div'=>false,'escape'=>false,'onClick'=>'addToBasket('.$pos1_dept_products[$w]['Product']['id'].',1,'.$pos1_dept_products[$w]['Product']['minimum_price_value'].','.$pos1_dept_products[$w]['Product']['minimum_price_seller'].','.$pos1_dept_products[$w]['Product']['new_condition_id'].');'));
										}else{
				...
				<p class="star-rating">
					...
					<span class="price">
						<strong>
							...
							<s><?php echo CURRENCY_SYMBOL.$format->money($pos2_newreleases[$j]['Product']['product_rrp'],2);?> </s>
							<?php }else{
								echo CURRENCY_SYMBOL.$format->money($pos2_newreleases[$j]['Product']['product_rrp'],2);
							} ?>
						</strong>
					</span>
				</p>
				...
				<p class="star-rating">
					...
					<span class="price">
						<strong>
							...
							<s><?php echo CURRENCY_SYMBOL.$format->money($pos3_newreleases[$k]['Product']['product_rrp'],2);?> </s>
							<?php }else{
								echo CURRENCY_SYMBOL.$format->money($pos3_newreleases[$k]['Product']['product_rrp'],2);
							}?>
						</strong>
					</span>
				</p>
				...
				<p class="star-rating">
					...
					<span class="price">
						...
						<?php if(!empty($pos3_dept_products[$x]['Product']['minimum_price_value']) && $pos3_dept_products[$x]['Product']['minimum_price_value'] > 0){ ?>
							<s><?php echo CURRENCY_SYMBOL.$format->money($pos3_dept_products[$x]['Product']['product_rrp'],2);?> </s>
						<?php }else{
							CURRENCY_SYMBOL.$format->money($pos3_dept_products[$x]['Product']['product_rrp'],2);
						}
						?>
						</strong>
					</span>
	...
	<div class="products-widget outerdiv_resolution div_resolution_middle_height">
		...
		<ul class="products">
			...
			<li class="inner_div_resolution"><div style ="padding:0 5px">
				...
				<p><?php echo $html->link($format->formatString($pos4_dept_products[$y]['Product']['product_name'],500),'/'.$this->Common->getProductUrl($pos4_dept_products[$y]['Product']['id']).'/categories/productdetail/'.$pos4_dept_products[$y]['Product']['id'],array('escape'=>false,));?></p>
				<p class="star-rating">
					<span class="pad-rt pad-tp"><?php  echo $rating; ?></span>
					<span class="price">
						<strong>
							<?php if((!empty($pos4_dept_products[$y]['Product']['minimum_price_value']) && ($pos4_dept_products[$y]['Product']['minimum_price_value'] > 0)) || (!empty($pos4_dept_products[$y]['Product']['minimum_price_used']) && ($pos4_dept_products[$y]['Product']['minimum_price_used'] > 0))){ ?>
								<s><?php echo CURRENCY_SYMBOL.$format->money($pos4_dept_products[$y]['Product']['product_rrp'],2);?> </s>
							<?php }else{
								echo CURRENCY_SYMBOL.$format->money($pos4_dept_products[$y]['Product']['product_rrp'],2);
							}?>
						</strong>
					</span>
				</p>
