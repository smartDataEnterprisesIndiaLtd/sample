...
<ul class="showngprdcts">
        <li>	Show
                    <?php  echo $form->select('Record.limit',array('10'=>'10','15'=>'15','20'=>'20','25'=>'25','50'=>'50','100'=>'100','200'=>'200'),$view_size,array('type'=>'select','onChange'=>'this.form.submit()', 'class'=>'textbox','label'=>false,'div'=>false,'error'=>false,'size'=>1, 'style' => 'width:38% !important;'));
			if(!empty($pass_url)){
