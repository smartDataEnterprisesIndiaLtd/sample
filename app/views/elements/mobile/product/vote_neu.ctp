...
<li>
	...
	<?php 
			echo $html->link($html->image("like-this-icon.png",array('width'=>"58",'height'=>"25", 'alt'=>"" ,'class'=>'img pad-rt')),'javascript::void(0)', array('Onclick'=>'likereviewneu('.$rev_neu_id.',1,1)','escape'=>false), null,false);
		?>
		<?php 
			echo $html->link($html->image("dislike-this.png",array('width'=>"32",'height'=>"25", 'alt'=>"" ,'class'=>'img pad-rt')),'javascript::void(0)', array('Onclick'=>'likereviewneu('.$rev_neu_id.',0,1)','escape'=>false), null,false);
		?>
	</div>
	<div class="pro-bar-bg"> <div class="pro-bar-total" style="width:<?php echo $like_width;?>px"> </div>
	<div class="pro-red" style="width:<?php echo $dislike_width;?>px;"> </div> </div>
</li>
<?php } else {?>
<li>
