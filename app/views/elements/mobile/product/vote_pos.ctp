...
?>
<!--li class="reviewer-count"><span class="gray"><?php //echo $total_votes;?> People found this helpful. Did you?</span><!--<a href="#"><strong>Yes</strong></a> | <a href="#"><strong>No</strong></a> --></li>
...
?>	<li>
	<div class="like-div-padding" >
		<?php 
			echo $html->link($html->image("like-this-icon.png",array('width'=>"58",'height'=>"25", 'alt'=>"" ,'class'=>'img pad-rt')),'javascript:void(0)', array('Onclick'=>'likereview('.$rev_pos_id.',1,2)','escape'=>false), null,false);
		?>
		<?php 
			echo $html->link($html->image("dislike-this.png",array('width'=>"32",'height'=>"25", 'alt'=>"" ,'class'=>'img pad-rt')),'javascript:void(0)', array('Onclick'=>'likereview('.$rev_pos_id.',0,2)','escape'=>false), null,false);
		?>
	</div>
	...
	<li>
		<div style="float:left;width:65px; padding-top:5px;">Thank you.</div>
		 ...
		 <div class="pro-bar-bg" style="padding-right:5px;"> 
		 	<div class="pro-bar-total" style="width:<?php echo $like_width;?>px"> </div>
		 	<div class="pro-red" style="width:<?php echo $dislike_width;?>px;"> </div> 
		 </div>
	</li>
<?php }?>
