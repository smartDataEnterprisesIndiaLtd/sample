			...
			<ul class="reviews-sec">
				...
				if(!empty($show_reviews[0])){
					if($show_reviews[0] == 'positive'){
						...
						<li>
							<ul class="review-status" itemprop="review" itemscope itemtype="http://schema.org/Review" >
								<li><span class="green-color min-width">
									<?php echo $html->image("positive-icon.png" ,array('width'=>"18",'height'=>"19", 'alt'=>"" ,'class'=>'img'));?> 
									<strong itemprop="name">Positive</strong>
								</span>
								</li> 
								<li><span class="smalr-fnt gray" itemprop="author">
									<?php $user_pos_email = '';
									if(!empty($pos_reviews[0]['User']['email'])){
										$user_po_ex = explode('@',$pos_reviews[0]['User']['email']);
										$user_pos_email = $user_po_ex[0];
									} echo $user_pos_email; ?> | <meta itemprop="datePublished" content="<?php echo $format->date_format($pos_reviews[0]['Review']['created']); ?>">
							...
							<?php foreach($pos_reviews as $pos_review) {
								...
								<p class="cl-widget" itemprop="description">&quot;<?php echo $this->Common->currencyEnter($pos_review['Review']['comments']); ?>&quot;</p>
								<ul class="review-status" itemprop="review" itemscope itemtype="http://schema.org/Review" style="padding-bottom:5px;">
						...
						<li>
							...
							<?php foreach($neg_reviews as $neg_review) {
								...
								<p class="cl-widget" itemprop="description">&quot;<?php echo $this->Common->currencyEnter($neg_review['Review']['comments']); ?>&quot;</p>
								<ul class="review-status" itemprop="review" itemscope itemtype="http://schema.org/Review" style="padding-bottom:5px;">
						...
						<li>
							...
							foreach($neu_reviews as $neu_review) {
								...
								<p class="cl-widget" itemprop="description">&quot;<?php echo $this->Common->currencyEnter($neu_review['Review']['comments']); ?>&quot;</p>
								<ul class="review-status" itemprop="review" itemscope itemtype="http://schema.org/Review" style="padding-bottom:5px;">
