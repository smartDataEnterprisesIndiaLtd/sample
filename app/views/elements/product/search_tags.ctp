	...
	<div class="fbtogether" style="verticle-align:middel">
		...
		<div class="search-tags">
			<ul>
				...
				<li><?php echo $html->link(ucwords($search_tag_arr[$index]),'/products/searchresult/keywords:'.trim($search_tag_arr[$index]),array('escape'=>false));?></li>
				<?php } $index++; }?>
			</ul>
		</div>
		<?php } ?>
		<div class="share-tags pad-top">
...
<!-- 				<a class="addthis_button_messanger"></a> -->
