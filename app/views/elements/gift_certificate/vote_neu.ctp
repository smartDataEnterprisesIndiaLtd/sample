...
?>
<li>
	<?php echo $ajax->link($html->image("like-this-icon.png",array('width'=>"58",'height'=>"25", 'alt'=>"" ,'class'=>'img pad-rt')),'javascript::void(0)', array('update' => 'vote_neu_'.$rev_gift_neu_id, 'url' => '/certificates/save_reviewvote/'.$rev_gift_neu_id.'/1/1',"indicator"=>"plsLoaderID",'loading'=>"Element.show('plsLoaderID')","complete"=>"Element.hide('plsLoaderID')",'escape'=>false), null,false);?>
</li>
<li>
	<?php echo $ajax->link($html->image("dislike-this.png",array('width'=>"32",'height'=>"25", 'alt'=>"" ,'class'=>'img pad-rt')),'javascript::void(0)', array('update' => 'vote_neu_'.$rev_gift_neu_id, 'url' => '/certificates/save_reviewvote/'.$rev_gift_neu_id.'/0/1',"indicator"=>"plsLoaderID",'loading'=>"Element.show('plsLoaderID')","complete"=>"Element.hide('plsLoaderID')",'escape'=>false), null,false);?>
</li>
<?php } else {?>
<li>Thank you.</li>
<?php }
