...
<div style="height:250px;width:720px; overflow-y: scroll; ">
...
if(count($dep_category_array) > 0 ){  
	foreach($dep_category_array as $cat_id_0 => $cat_name_0){
		...
		if(count($cat_array_1) > 0 ){ 
			echo '<div style="padding: 5px 0px 5px 10px;">';
			//////////////////////////////////////// 1st level ////////////////////////////////////////
			$j = 0;
			foreach($cat_array_1 as $cat_id_1 => $cat_name_1){
				...
				if(count($cat_array_2) > 0 ){
					...
					foreach($cat_array_2 as $cat_id_2 => $cat_name_2){
						...
						if(count($cat_array_3) > 0 ){
							...
							foreach($cat_array_3 as $cat_id_3 => $cat_name_3){
								...
								if(count($cat_array_4) > 0 ){
									...
									foreach($cat_array_4 as $cat_id_4 => $cat_name_4){
											...
											echo "<input type=\"checkbox\" value=\"$cat_id_4\" name=\"data[ProductCategory][".$department_id."][] \" $checked_category4 >";
											echo "&nbsp;";echo ucwords($cat_name_4); echo "&nbsp;";
											echo "&nbsp;&nbsp;&nbsp;";
								...
								echo "</div></div>";
									...
									echo "<input type=\"checkbox\" value=\"$cat_id_3\" name=\"data[ProductCategory][".$department_id."][] \" $checked_category3>";
									echo "&nbsp;";echo ucwords($cat_name_3); echo "&nbsp;";
									echo "&nbsp;&nbsp;&nbsp;"; 
								} 
							}// 3rd foreach
							echo '</div>';
							...
							echo "<input type=\"checkbox\" value=\"$cat_id_2\" name=\"data[ProductCategory][".$department_id."][] \" $checked_category2>";
							echo "&nbsp;";echo ucwords($cat_name_2); echo "&nbsp;";
							echo "&nbsp;&nbsp;&nbsp;";
						}
					} // 2ndst foreach 
					echo "</div>";	
				//////////////////////////////////////// 2nd level  ends ////////////////////////////////////////	
					...
					echo "<input type=\"checkbox\" value=\"$cat_id_1\" name=\"data[ProductCategory][".$department_id."][] \" $checked_category1>";
					echo "&nbsp;";echo ucwords($cat_name_1); echo "&nbsp;";
					echo "&nbsp;&nbsp;&nbsp;";
					//if($j%5 == 0){ echo "<br />";}
				}
			} //// ist foreach 
			...
			echo "<input type=\"checkbox\" value=\"$cat_id_0\" name=\"data[ProductCategory][".$department_id."][] \" $checked_category0 >";
			echo "&nbsp;";echo ucwords($cat_name_0); echo "&nbsp;";
			echo "&nbsp;&nbsp;&nbsp;";
