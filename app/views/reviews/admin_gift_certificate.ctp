...
$this->Html->addCrumb('Promotions', '/admin/certificates');
	$this->Html->addCrumb('Manage Gift Certificate Reviews', 'javascript:void(0)');
$url = array(
	'keyword' =>$keyword,	
	'searchin' => $fieldname,
	'showtype' => $show
...
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" valign="top">
	<tr>
		...
		<?php echo $html->link('<span>Add New</span>',array("controller"=>"reviews","action"=>"add_gift_certificate") , array('escape'=>false,'class'=>'wt_btn','title'=>'Add New') ); ?>	
		</td>
	</tr>
				...
				<tr>
					<td>
						<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
							<tr>
								<td>
									<?php echo $form->create("Review",array("action"=>"gift_certificate","method"=>"Post", "id"=>"frmSearchReview", "name"=>"frmSearchReview"));?>
				...
				<tr>
					<td>
						<table   align="center" width="100%" border="0" cellpadding="0" cellspacing="0" >
							<tr>
								<td colspan="2" >
									<?php echo $this->element('admin/giftreviews_listing');?>
								</td>
							</tr>
