...
jQuery(document).ready(function(){
	jQuery("#openNewLink").click(function(){
		window.parent.location.href = '<?php echo SITE_URL ?>pages/view/conditions-of-use';
...
<ul class="pop-con-list">
	...
	<li>
		...
		<?php
		$options=array('2'=>'<span class="grn-color"><strong>Positive</strong></span>','0'=>'<span class="red-color-text"><strong>Negative</strong></span>','1'=>'<span class="gr-colr"><strong>Neutral</strong></span>');
	...
	<li>
		...
		<?php echo $form->input('Review.comments',array('size'=>'30','label'=>false,'class'=>$errorComments,'rows'=>'5','cols'=>'45','div'=>false,'error'=>false,'maxlength'=>3000)); //echo $form->error('Review.comments'); ?></p>
		<p class="smlr-fnt"><strong>Please note:</strong> do not include any website links, if you wish to refer to another project on Choiceful.com enter its Quick Code. All  reviews are periodically checked and Choiceful.com reserves the right to remove/edit any part of this content if it does not comply with our 
		<?php echo $html->link('user agreement','javascript:void(0)',array('escape'=>false,'id'=>'openNewLink'));?>
		</p>
	</li>
	<li>
