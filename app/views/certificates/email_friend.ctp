...
<?php  echo $form->create('Certificate',array('action'=>'email_friend','method'=>'POST','name'=>'frmCertificateamil','id' =>'frmCertificateamil'));
	...
	<li>
		<ul class="ad-form-widget" style="width:385px !important;">
			...
			<li>
				...
				<?php echo $form->input('Certificate.recipient_name',array('error'=>false,'size'=>'30','type'=>'text','maxlength'=>30,'label'=>false,'class'=>$errorRecipientName,'div'=>false,'style'=>'float:left;margin-right:5px'));?>
			</li>
			<li>
				...
				<?php echo $form->input('Certificate.recipient_email',array('error'=>false,'size'=>'30','type'=>'text','maxlength'=>30,'label'=>false,'class'=>$errorRecipientEmail,'div'=>false,'style'=>'float:left;margin-right:5px'));?>
			</li>
			<li>
				...
				<?php echo $form->input('Certificate.your_name',array('error'=>false,'size'=>'30','type'=>'text','maxlength'=>30,'label'=>false,'class'=>$errorYourName,'div'=>false,'style'=>'float:left;margin-right:5px'));?>
			</li>
			<li>
