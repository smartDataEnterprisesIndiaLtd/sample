...
$this->Html->addCrumb('Promotions', '/admin/certificates');
	$this->Html->addCrumb(' Manage Gift Certificate Questions', 'javascript:void(0)');
...
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" valign="top">
	<tr>
		...
		<?php echo $html->link('<span>Add New</span>',array("controller"=>"certificates","action"=>"add_question") , array('escape'=>false,'class'=>'wt_btn','title'=>'Add New') ); ?>		
		</td>
	</tr>
		...
		<td colspan="2">
 			<table width="100%" cellspacing="0" cellpadding="0" align="center" border="0">
				<tr class="adminBoxHeading">
					<td height="25" class="reportListingHeading">Search Question</td>
				</tr>
				<tr>
					<td>
						<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
							<tr>
								<td>
									<?php echo $form->create("Certificates",array("action"=>"admin_questions","method"=>"Post", "id"=>"frmSearchCertificateQuestion", "name"=>"frmSearchCertificateQuestion"));?>
				...
				<tr>
					<td>
						<table   align="center" width="100%" border="0" cellpadding="0" cellspacing="0" >
							<tr>
								<td colspan="2" >
									<?php echo $this->element('admin/certficate_questions_listing');?>
								</td>
							</tr>
