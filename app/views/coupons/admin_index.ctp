...
$this->Html->addCrumb('Promotions', '/admin/certificates');
	$this->Html->addCrumb('Manage coupon', 'javascript:void(0)');
$url = array(
	'keyword' =>$keyword,	
	'searchin' => $fieldname,
	'showtype' => $show
...
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" valign="top">
	<tr>
		...
		<?php echo $html->link('<span>Add New</span>',array("controller"=>"coupons","action"=>"add") , array('escape'=>false,'class'=>'wt_btn','title'=>'Add New') ); ?>		
		</td>
	</tr>
		...
		<td colspan="2">
 			<table width="100%" cellspacing="0" cellpadding="0" align="center" border="0">
				<tr class="adminBoxHeading">
					<td height="25" class="reportListingHeading">Search coupon</td>
				</tr>
				<tr>
					<td>
						<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
							<tr>
								<td>
									<?php echo $form->create("Coupon",array("action"=>"index","method"=>"Post", "id"=>"frmSearchCoupon", "name"=>"frmSearchCoupon"));?>
				...
				<tr>
					<td>
						<table   align="center" width="100%" border="0" cellpadding="0" cellspacing="0" >
							<tr>
								<td colspan="2" >
									<?php echo $this->element('admin/coupons_listing');?>
								</td>
							</tr>
