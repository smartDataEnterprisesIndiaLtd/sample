...
$this->Html->addCrumb('Website Pages', '/admin/faqs');
	$this->Html->addCrumb('Manage Footer Banner', 'javascript:void(0)');
$url = array(
	'keyword' =>$keyword,
	'searchin' => $fieldname
	);
...
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" valign="top">
	<tr>
		<td class="adminGridHeading heading"><?php echo $listTitle;?></td>
			...
			<?php
                            if($bannerCount<8){
                                echo $html->link('Add New','/admin/pages/addbanner');
                            }
                        ?>&nbsp;&nbsp;
		</td>
	</tr>
				...
				<tr>
					<td>
						<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
							<tr>
								<td>
									<?php echo $form->create("Pages",array("action"=>"footerbanner","method"=>"Post", "id"=>"frmSearchPages", "name"=>"frmSearchPages"));?>
				...
				<tr>
					<td>
						<table   align="center" width="100%" border="0" cellpadding="0" cellspacing="0" >
							<tr>
								<td colspan="2" >
									<?php echo $this->element('admin/banner_listing');?>
								</td>
							</tr>
