		...
		<?php } ?>
			...
			<?php  if(!empty($product_details['Product']['product_image'])){
				...
				if(file_exists($main_imagePath)){
					echo $html->image('/'.PATH_PRODUCT."medium/img_150_".$product_details['Product']['product_image'], array('alt'=>"",  'width'=>"110"));
				}else{
					echo $html->image('/img/no_image_150.jpg', array('alt'=>"", 'width'=>"110"));
				}
			}?>
                    </section>
				...
				echo $html->link('Click to enlarge',$linkmain_str,array('escape'=>false,'class'=>'view-larger large-image', 'style'=>'color:#BBBBBB'));?>
			...
			?>
				...
				<?php echo $common->displayProductRatingYellow($product_details['Product']['avg_rating'],$product_details['Product']['id']); ?>
                            </p>
					...
					<?php } else if($stockInfo['ProductSeller']['quantity'] <= 0 ||  empty($stockInfo['ProductSeller']['quantity'])  ){ ?>
						<p class="lrgr-fnt redcolor"><strong>Sorry - temporarily out of stock</strong></p>
					<?php } else{ ?>
						<p class="green-color larger-fnt margin-top">
							...
							echo $html->link($sellerDetails['Seller']['business_display_name'],'/sellers/'.$seller_name.'/summary/'.$sellerDetails['User']['id'].'/'.$product_details['Product']['id'],array('escape'=>false,'class'=>'bigger-font rate'));//pr($product_details); ?>
                           			</p>
					<?php } ?>
                            </li>
                            <li class="margin-top">
				...
				<?php }else if(!empty($usedLowestPriceSeller) ){  // IF seller exists for used condition ?>
					...
					if( empty($stockInfo) ) {
						...
						<input id="prod_quantity_id" type="text" name="qty" class="textfield" value="1" style="width:44px; vertical-align:middle;" />
			...
			<div di="tabs123">
				<ul class="tabs">
						...
						<li><a href="#tab4">Reviews/Q&amp;A</a></li>
				</ul>
			</div>
                        <!---->
					...
					?>
                            ...
                            <div id="tab3" class="tab_content"> 
                              ...
                              <ul class="delvrycntnt">
                                <li>
                                	<strong>Want guarateed delevery by <?php
