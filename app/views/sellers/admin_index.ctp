...
$this->Html->addCrumb(' Manage Sellers', 'javascript:void(0)');
...
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" valign="top">
	<tr>
		...
		<td class="adminGridHeading" height="25px" align="right">
			...
			<?php echo $html->link('<span>Download Now</span>',array("controller"=>"sellers","action"=>"export") , array('escape'=>false,'class'=>'wt_btn','title'=>'Download Now') ); ?>
		
		<?php echo $html->link('<span>Add New</span>',array("controller"=>"sellers","action"=>"add") , array('escape'=>false,'class'=>'wt_btn','title'=>'Add New') ); ?>
		</td>
	</tr>
				...
				<tr>
					<td>
						<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
							<tr>
								<td>
									<?php echo $form->create("Seller",array("action"=>"index","method"=>"Post", "id"=>"frmUser", "name"=>"frmUser"));?>
			...
			<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<table   align="center" width="100%" border="0" cellpadding="0" cellspacing="0" >
							<tr>
								<td colspan="2" id = 'listing'>
									<?php echo $this->element('admin/seller_listing');?>
								</td>
							</tr>
						</table>
				...
				<tr>
					<td class="legends">
						...
						<?php echo $html->image("reports_icon.png", array("alt"=>"Payment Reports",'style'=>'border:0px',));?> Payment Reports
						<?php echo $html->image('seller_list.png',array('border'=>0,'alt'=>'Delete','title'=>'Manage Product List')); ?>&nbsp;Manage Product List &nbsp;
					</td>
				</tr>
				<!-- Legends -->
			</table>
