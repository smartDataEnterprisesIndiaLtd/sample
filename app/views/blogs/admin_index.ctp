...
$this->Html->addCrumb('Promotions', '/admin/certificates');
	$this->Html->addCrumb('Manage Blog Articles', 'javascript:void(0)');
...
?>
	...
	<tr>
		...
		<?php if( count($blogs) >1 )  echo'('.count($blogs).' Articles)'; else echo '('.count($blogs).' Article)';?> </td>
		<td class="adminGridHeading" height="25px" align="right">
			
		<?php echo $html->link('<span>Add New Blog Article</span>',array("controller"=>"blogs","action"=>"add") , array('escape'=>false,'class'=>'wt_btn','title'=>'Add New Blog Article') ); ?>
		
		<?php echo $html->link('<span>Question & Answer Management</span>',array("controller"=>"blogs","action"=>"reviewquestions") , array('escape'=>false,'class'=>'wt_btn','title'=>'Add New Blog Article') ); ?>
		...
		<td colspan="2">
 			<table width="100%" cellspacing="0" cellpadding="0" align="center" border="0">
				<tr class="adminBoxHeading">
					<td height="25" class="reportListingHeading">Search Choiceful Blog Articles</td>
				</tr>
				<tr>
					<td>
						<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
							<tr>
								<td>
									<?php echo $form->create("Blog",array("action"=>"index","method"=>"Post", "id"=>"frmSearchBlog", "name"=>"Blog"));?>
	...
	<tr>
		<td colspan="2" id="blog_pagging">
			<?php echo $this->element('blogs/blog_listing'); ?>
		</td>
	</tr>
	<tr><td>&nbsp;</td></tr>
	<tr>
