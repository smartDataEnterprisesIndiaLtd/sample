							...
							<div class="billing-info-left">
								...
								<ul>
									...
									<li>
										...
										<div class="form-field-widget">
										<?php echo $form->input('Order.billing_firstname',array('onkeyup'=>'PutThisDataInShippingAsWell(this.value,2)','maxlength'=>'100','class'=>'form-textfield','label'=>false, 'div'=>false));?>
									...
									<li>
										...
										<div class="form-field-widget">
										<?php echo $form->input('Order.billing_lastname',array('onkeyup'=>'PutThisDataInShippingAsWell(this.value,3)', 'maxlength'=>'100','class'=>'form-textfield','label'=>false, 'div'=>false));?>
									...
									<li>
										...
										<div class="form-field-widget">
											<?php echo $form->input('Order.billing_address1',array('onkeyup'=>'PutThisDataInShippingAsWell(this.value,4)', 'maxlength'=>'100','class'=>'form-textfield','label'=>false, 'div'=>false));?>
									...
									<li>
										<label>&nbsp;</label>
										<div class="form-field-widget">
											<?php echo $form->input('Order.billing_address2',array('onkeyup'=>'PutThisDataInShippingAsWell(this.value,5)', 'maxlength'=>'100','class'=>'form-textfield','label'=>false, 'div'=>false));?>
										</div>
									</li>
									<li>
										<label><span class="star">*</span> Town/city:</label>
										<div class="form-field-widget">
											<?php echo $form->input('Order.billing_city',array('onkeyup'=>'PutThisDataInShippingAsWell(this.value,6)', 'maxlength'=>'100','class'=>'form-textfield','label'=>false,'div'=>false));?>
									...
									<li>
										...
										<div class="form-field-widget">
											<?php echo $form->input('Order.billing_postal_code',array('onkeyup'=>'PutThisDataInShippingAsWell(this.value,8)', 'maxlength'=>'100','class'=>'form-textfield','label'=>false,'div'=>false, 'style'=>'width:30%;'));?>
									...
									<li>
										...
										<?php echo $form->select('Order.billing_country_id',$countries,$this->data['Order']['billing_country_id'],array('type'=>'select','class'=>'select','label'=>false,'div'=>false,'size'=>1),'Select');
									...
									<li>
										...
										<div class="form-field-widget">
										<?php echo $form->input('Order.billing_phone',array('onkeyup'=>'PutThisDataInShippingAsWell(this.value,10)', 'maxlength'=>'100','class'=>'form-textfield','label'=>false,'div'=>false));?>
							...
							<div class="form-widget">
								<ul>
									...
									<li>
										<label><span class="star">*</span> First Name:</label>
										<div class="form-field-widget">
										<?php echo $form->input('Order.shipping_firstname',array('maxlength'=>'100','class'=>'form-textfield','label'=>false, 'div'=>false));?>
									...
									<li>
										<label><span class="star">*</span> Surname:</label>
										<div class="form-field-widget">
											<?php echo $form->input('Order.shipping_lastname',array('maxlength'=>'100','class'=>'form-textfield','label'=>false, 'div'=>false));?>
									...
									<li>
										<label><span class="star">*</span> Address:</label>
										<div class="form-field-widget">
										<?php echo $form->input('Order.shipping_address1',array('maxlength'=>'100','class'=>'form-textfield','label'=>false, 'div'=>false));?>
									...
									<li>
										<label>&nbsp;</label>
										<div class="form-field-widget">
											<?php echo $form->input('Order.shipping_address2',array('maxlength'=>'100','class'=>'form-textfield','label'=>false, 'div'=>false));?>
									...
									<li>
										<label><span class="star">*</span> Town/city:</label>
										<div class="form-field-widget">
										<?php echo $form->input('Order.shipping_city',array('maxlength'=>'100','class'=>'form-textfield','label'=>false,'div'=>false));?>
									...
									<li>
										<label><span class="star">*</span> Post Code:</label>
										<div class="form-field-widget">
											<?php echo $form->input('Order.shipping_postal_code',array('maxlength'=>'100','class'=>'form-textfield','label'=>false,'div'=>false, 'style'=>'width:30%;'));?>
									...
									<li>
										...
										<div class="form-field-widget">
											...
											<?php echo $form->select('Order.shipping_country_id',$shippingCountries,$this->data['Order']['shipping_country_id'],array('type'=>'select','class'=>'select',"disabled"=>$disabledsh,'label'=>false,'div'=>false,'size'=>1),'Select');
									...
									<li>
										...
										<div class="form-field-widget" >
											...
											<?php echo $form->input('Order.shipping_state',array('maxlength'=>'100','class'=>'form-textfield','label'=>false,'div'=>false));?>
											</div>
									...
									<li>
										<label><span class="star">*</span> Telephone No:</label>
										<div class="form-field-widget">
										<?php echo $form->input('Order.shipping_phone',array('maxlength'=>'100','class'=>'form-textfield','label'=>false,'div'=>false));?>
								...
								<div class="ship-option-grid margin-tp-btm">
									...
									<div class="ship-option-grid-row overflow-h gray-bg-row">
										<ul>
											...
											<li class="delivery-choice-col12">Standard Shipping</li>
									...
									<div class="ship-option-grid-row overflow-h">
										<ul>
											...
											<li class="delivery-choice-col12">Express Shipping</li>
