         ...
         <div class="checkout-right-content1">
           ...
           <div class="form-checkout-widget1">
                  ...
                  <div class="form-widget">
					...
					<div class="messageBlock" style="width:100%; margin-top:-10px;"><?php echo $session->flash();?></div>
					<?php } ?>
						...
						?>
                                            	<p><strong><?php echo $sessOrderData['shipping_user_title']." ".$sessOrderData['shipping_firstname']." ".$sessOrderData['shipping_lastname']; ?></strong></p>
						...
						<p><strong><?php echo $sessOrderData['shipping_postal_code'];?></strong></p>
							...
							<?php echo $html->link( $html->image('checkout/change-btn.gif', array('width'=>"46" ,'height'=>"14", 'alt'=>"", 'class'=>"v-align-middle margn-lt", 'border'=>'') ) , '/checkouts/step3' , array('div'=>false, 'label'=>false, 'escape'=>false)  );?>
                                        ...
                                        <li><h3 class="bl-dif">Ordered Items</h3></li>
					<?php
					//pr($cartData);
					...
					?>
                                        <li>
						<div class="arrow">
							<?php  echo $html->image('checkout/lt-blue-arrow.png',  array('width'=>5, 'height'=>9, 'alt'=>'') ); ?>
						</div>
						<div class="billing-add">
						...
						<p>
							<?php  echo $html->image('gift-icon.gif',  array('width'=>13, 'height'=>13, 'alt'=>'', 'class'=>'v-align-middle') ); ?>
...
// 					$total_order_before_tax  = ($total_order_cost - $tax_total_cost);
					...
					?>
						...
						?>
                                            	<p><?php echo $sessOrderData['billing_user_title']." ".$sessOrderData['billing_firstname']." ".$sessOrderData['billing_lastname']; ?></p>
					...
					<div class="side-content border gray">
                                    	...
                                    	<?php echo $form->create("Checkout", array('action'=>'applyDiscountCoupon','name'=>'frmCoupon'));?>  
					...
					<div class="padding-row">
					  ...
					  <div id="coupon_code_error" class="error-message-simple"></div> 
					       ...
					       <?php  echo $form->submit('checkout/update-btn.png',  array('type'=>'image', 'div'=>false, 'label'=>false, 'class'=>'v-align-middle', 'style'=>"cursor:pointer;") ); ?>					       
                                            </p>
                                        </div>
                                    <?php echo $form->end(); ?>
			...
			?>
			    ...
			    <div class="ship-option-grid margin-tp-btm">
                                 ...
                                 <div class="ship-option-grid-head overflow-h">
                                    	<ul>
                                          ...
                                          <li class="delivery-choice-col12"><strong>Shipping Methods</strong></li>
						...
						<!--<input type="radio" name="radio" class="checkbox" value="radio" />-->
                                            ...
                                            <li class="delivery-choice-col12"><span class="<?=$stdClass?>"> Standard Shipping</span></li>
                                            <li class="delivery-choice-col12">Up to 9 Business Days</li>
				...
				<!--Shipping Option Grid Row Start-->
                                 <div class="ship-option-grid-row overflow-h">
                                    	<ul>
                                            ...
                                            <li class="delivery-choice-col12"><span class="<?=$expClass?>">Express Shipping</span></li>
                                            <li class="delivery-choice-col12">Up to 2 Business Days</li>
			 ...
			 ?> 
				 ...
				 <?php  if($sessOrderData['insurance'] == '1') { 	?>
                                                <li>
                                                    <div class="d-arrow">
							<?php  echo $html->image('checkout/d-arrow-icon.png',  array('height'=>7, 'width'=>7, 'alt'=>'') ); ?>
							</div>
                                                    <div class="summary-text1"> <span class="green-color">Add Additional Insurance - <?php echo CURRENCY_SYMBOL, $settings['Setting']['insurance_charges'];?></span> (<?php echo $html->link("what's  this?", '/checkouts/insurance_popup',   array('class'=>'underline-link fancy_box_open') );?>)</div>
                                                </li>
					<?php  } ?>
                              </ul>
			...
			?>
			  <div class="checkout-pro-widget">
				 ...
				 <p><strong>How would you like to pay for your order?</strong></p>
				<?php
				...
				<div class="payment-options">
                            	<ul>
                                	<!--li>
						<input  <?=$sageChecked?> id="payment_option_id1" type="radio" name="data[Order][payment_method]" class="checkbox" value="1" /> 
						<?php
						//echo $html->image('checkout/visa-logo.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id1').checked=true" ) );
						//echo $html->image('checkout/mastercard-logo.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id1').checked=true" ) );
						//echo $html->image('checkout/switch-card.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id1').checked=true" ) );
						//echo $html->image('checkout/delta-card.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id1').checked=true" ) );
						//echo $html->image('checkout/visa-electron-logo.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id1').checked=true" ) );
						//echo $html->image('checkout/master-card-logo.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id1').checked=true" ) );
						?>
					</li-->
						...
						<?php
						echo $html->image('checkout/visa-logo.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id5').checked=true" ) );
						echo $html->image('checkout/mastercard-logo.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id5').checked=true" ) );
						echo $html->image('checkout/switch-card.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id5').checked=true" ) );
						echo $html->image('checkout/delta-card.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id5').checked=true" ) );
						echo $html->image('checkout/visa-electron-logo.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id5').checked=true" ) );
						echo $html->image('checkout/master-card-logo.png',  array('width'=>33, 'height'=>23, 'alt'=>'',"onclick"=>"document.getElementById('payment_option_id5').checked=true" ) );
						?>
				    </li>
                                    <li class="checkout-with-paypal">
						<input id="payment_option_id2" type="radio" name="data[Order][payment_method]" class="checkbox rd2" value="2" /> 
						<?php  echo $html->image('checkout/checkout-with-paypal.png',  array('alt'=>'paypal', 'title'=>'paypal', "onclick"=>"document.getElementById('payment_option_id2').checked=true") ); ?>
				    </li>
                                     <!--li class="float-right">
						<input id="payment_option_id3" type="radio" name="data[Order][payment_method]" class="checkbox rd3" value="3" /> 
						<?php  //echo $html->image('checkout/google-checkout-method.png',  array('alt'=>'google checkout', 'alt'=>'google checkout',"onclick"=>"document.getElementById('payment_option_id3').checked=true") ); ?>
				     </li-->
			...
			<?php  } ?>
		       ...
		       <li>
                      	  <div class="checkout-pro-widget">
				<div style="line-height: 18px;"><strong>Please note</strong> we are now transferring you to our secure payment server.<br/>Do not click back on your browser, in the rare event that you experience any problems with payment please close your browser and try again.</div>
