 ...
 <!--Content Start-->
    <div id="checkout-content">
	  ...
	  <?php echo $this->element('checkout/left'); // include left side bar ?>
        <!--Left Content Closed-->
        <div class="right-con" style="width:130px;">&nbsp;</div>
         <!--Right Content Start-->
	...
	<?php } ?>
		...
		<?php echo $form->create("Checkout", array('action'=>'step2','default' => true,'name'=>'frmCheckout'));?>
		  ...
		  <h2 class="gray margin-bottom">add giftwrap and write a free message</h2>
		  <div class="form-widget">
                    <ul>
					...
					<ul>
                        ...
                        <!--Checkout Product Right Start-->
                                <div class="checkout-pro-right">
                                	<ul>
                                    	<li><i>Enter your gift notes for this item here:</i></li>
                                        <li>
			...
			<?php  } } ?>	
                        ...
                        <li class="smalr-fnt">
                        	 <div style="border: medium none ;" class="checkout-pro-widget">
                                  ...
                                  <p>Items designated as gift that are shipped from Choiceful.com to a single address will not display prices on their packaging documentation</p>
                             </div>
                        </li>
                       <li>
                      	  <div class="checkout-pro-widget">
