						...
						<table   align="center" width="100%" border="0" cellpadding="0" cellspacing="0" >
							<tr>
								<td colspan="2" id = 'listing'>
									<!--- Start list table-->
											<?php if(isset($arrRefundedOrder) && is_array($arrRefundedOrder) && count($arrRefundedOrder) > 0){?>
												<table width="100%" cellpadding="2" cellspacing="1"  border="0"  class="borderTable">
													<tr>
														<td align="left" class="adminGridHeading" width="30%" >Seller Name </td>
														<td class="adminGridHeading" align="center" width="30%" >Refunded rates</td>
													</tr>
													<?php
														$class= 'rowClassEven';
														foreach ($arrRefundedOrder as $arrRefundedOrder) {
														$class = ($class == 'rowClassEven')?'rowClassOdd':'rowClassEven';
														
													?>
													<tr class="<?php echo $class?>">
														<td align="left"><?php $sellerInfo = $this->Common->getSellerInfo($arrRefundedOrder['seller_id']);
																echo $sellerInfo['Seller']['business_display_name'];	
																
																
															?></td>
														<td align="center"><strong><?php $rates=$arrRefundedOrder['refundedrate'];
																		echo round($rates, 2);
														?></strong></td>
													</tr>
													<?php }?>
