						...
						<table   align="center" width="100%" border="0" cellpadding="0" cellspacing="0" >
							<tr>
								<td colspan="2" id = 'listing'>
									<!--- Start list table-->
											<?php if(isset($arrCancle) && is_array($arrCancle) && count($arrCancle) > 0){?>
												<table width="100%" cellpadding="2" cellspacing="1"  border="0"  class="borderTable">
													<tr>
														<td align="left" class="adminGridHeading" width="30%" >Seller Name </td>
														<td class="adminGridHeading" align="center" width="30%" >Pre-shipped cancel rates</td>
													</tr>
													<?php
														$class= 'rowClassEven';
														foreach ($arrCancle as $arrCancle) {
														$class = ($class == 'rowClassEven')?'rowClassOdd':'rowClassEven';
														
													?>
													<tr class="<?php echo $class?>">
														<td align="left"><?php $sellerInfo = $this->Common->getSellerInfo($arrCancle['seller_id']);
																echo $sellerInfo['Seller']['business_display_name'];	
																
																
															?></td>
														<td align="center"><strong><?php $rates=$arrCancle['rate'];
														echo round($rates, 2);
														?></strong></td>
													</tr>
													<?php }?>
