											...
											<?php if(isset($bestSellingProduct) && is_array($bestSellingProduct) && count($bestSellingProduct) > 0){?>
												<table width="100%" cellpadding="2" cellspacing="1"  border="0"  class="borderTable">
													...
													<tr class="<?php echo $class?>">
														<td align="left">
															<?php $category_name=$this->Common->getCategoryName($bestSellingProduct['ProductCategory']['category_id']); echo $bestSellingProduct['ProductCategory']['category_id'];
																echo $category_name[0]['Category']['cat_name'];
