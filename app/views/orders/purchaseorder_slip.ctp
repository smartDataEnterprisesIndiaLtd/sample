	...
	<tr>
		<td style="padding:15px 0; border-bottom:2px #cccccc solid;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="63%"><?php echo $html->image("Choicefullogo.jpg",array('width'=>"150",'height'=>"24",'alt'=>"",'style'=>"border:0;"))?></td>
					<td width="37%" style="font-size:12px;"><label style=" font-weight:bold; width:160px; display:inline-block;font-size:12px;">Order ID:</label>
					<?php if(!empty($order_details['Order']['order_number'])) echo $order_details['Order']['order_number']; ?><br />
					<label style="font-weight:bold; width:160px; display:inline-block;font-size:12px;"> Order Date:</label>
	...
	<tr>
		 <td style="padding:15px 20px; line-height:1.5;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;">
				<tr>
					<td valign="top" style="padding-right:45px;line-height:1.5;">
					...
					<td valign="top" style="padding-left:45px;line-height:1.5;">
