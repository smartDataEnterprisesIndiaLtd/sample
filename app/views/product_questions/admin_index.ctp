...
$this->Html->addCrumb('Product Management', '/admin/products');
	$this->Html->addCrumb('Product Question & Answers', 'javascript:void(0)');
$url = array(
	'keyword' =>$keyword,	
	'searchin' => $fieldname,
	'showtype' => $show
...
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" valign="top">
	<tr>
		...
		<?php echo $html->link('<span>Add New</span>',array("controller"=>"product_questions","action"=>"add") , array('escape'=>false,'class'=>'wt_btn','title'=>'Add New') ); ?>	
				...
				<tr>
					<td>
						<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
							<tr>
								<td>
									<?php echo $form->create("ProductQuestion",array("action"=>"index","method"=>"Post", "id"=>"frmSearchProductQuestion", "name"=>"frmSearchProductQuestion"));?>
				...
				<tr>
					<td>
						<table   align="center" width="100%" border="0" cellpadding="0" cellspacing="0" >
							<tr>
								<td colspan="2" >
									<?php echo $this->element('admin/questions_listing');?>
								</td>
							</tr>
