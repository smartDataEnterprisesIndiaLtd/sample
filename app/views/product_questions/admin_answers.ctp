...
$url = array(
	'/'.$question_detail['ProductQuestion']['id'],
	'keyword' =>$keyword,
	'searchin' => $fieldname,
	'showtype' => $show
	);
...
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" valign="top">
	<tr>
		...
		<td class="adminGridHeading" height="25px" align="right">
			<?php echo $html->link("Add New",array("controller"=>"product_questions","action"=>"add_answer",$question_detail['ProductQuestion']['id'])); ?>
		</td>
	</tr>
				...
				<tr>
					<td>
						<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
							<tr>
								<td>
									<?php echo $form->create("ProductQuestion",array("action"=>"answers/".$question_detail['ProductQuestion']['id'],"method"=>"Post", "id"=>"frmSearchProductAnswer", "name"=>"frmSearchProductAnswer"));?>
								...
								<td>
									<table width="100%" cellspacing="1" cellpadding="1" align="center" border="0">
										...
										<tr>
											...
											<td colspan="3" >
												<?php echo html_entity_decode($this->Common->currencyEnter($question_detail['ProductQuestion']['question']), ENT_NOQUOTES, 'UTF-8');?>
											</td>
										</tr>
									</table>
								</td>
				...
				<tr>
					<td>
						<table   align="center" width="100%" border="0" cellpadding="0" cellspacing="0" >
							<tr>
								<td colspan="2" >
									<?php echo $this->element('admin/answers_listing');?>
								</td>
							</tr>
