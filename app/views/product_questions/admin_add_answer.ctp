...
echo $form->create('ProductQuestion',array('action'=>'add_answer/'.$ques_id.'/'.$id,'method'=>'POST','name'=>'frmProductQuestion','id'=>'frmProductQuestion'));
?>	
								...
								<td>
									<table width="100%" cellspacing="1" cellpadding="1" align="center" border="0">
										<tr>
											...
											<td >
												<?php echo $question_detail['Product']['product_name']; ?>
											</td>
											<td >Quick code : </td>
											<td >
												<?php echo $question_detail['Product']['quick_code']; ?>
											</td>
										</tr>
										<tr>
											<td align="left">Question : </td>
											<td colspan="3" >
												<?php echo $question_detail['ProductQuestion']['question']; ?>
											</td>
										</tr>
									</table>
								</td>
	...
	<tr>
		<td colspan="2">
			<table width="100%" border="0" cellspacing="1" cellpadding="3" class="adminBox">
				...
				<tr>
					<td align="right" width="20%" valign="top"><span class="error_msg">*</span> Answer : </td>
					<td><?php echo $form->textarea("ProductAnswer.answer",array("label"=>false,"div"=>false, 'class'=>'textbox-l','rows'=>10,'maxlength'=>500, 'cols'=>100, 'showremain'=>"limitOne")); ?><?php echo $form->error('ProductAnswer.answer'); ?>
					<?php echo $form->hidden("ProductAnswer.product_question_id",array('type'=>'text')); ?>
					<?php echo $form->hidden("ProductAnswer.id",array('type'=>'text')); ?>
				...
				<tr>
					...
					<td align="left">
						<?php 
						if(empty($this->data['ProductAnswer']['id']))
							$submit_buttton="Add";
						else
							$submit_buttton="Update";
						echo $form->button($submit_buttton,array('type'=>'submit','class'=>'btn_53','div'=>false));?> 
						<?php echo $form->button('Cancel',array('type'=>'button','class'=>'btn_53','onClick'=>"goBack('/admin/product_questions/answers/$ques_id');"));?>
					</td>
				</tr>
			</table>
		</td>
