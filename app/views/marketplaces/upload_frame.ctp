...
$url = SITE_URL."/marketplaces/upload_frame";//basename($_SERVER['SCRIPT_FILENAME']);
...
<?php echo $html->css('style_progress'); ?>
		...
		function(data)	//return information back from jQuery's get request
			{
				...
				$('#progress_completed').html(parseInt(data) +"% completed");	//display the % completed within the progress bar
			}
...
</div><div id="progress_completed"></div>
<!---->
</body>